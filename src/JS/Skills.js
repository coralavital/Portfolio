                ...
                <div className="row">
                    <div className="col__3">
                        <div className="skills__box pointer">
                            ...
                            <div className="skills__meta">
                                <h1 className="skills__text">Server side</h1>
                                <p className="p skills__text p__color">Python</p>
                                <p className="p skills__text p__color">Java</p>
                                <p className="p skills__text p__color">Node.js</p>
                                <p id="fake" className="p skills__text p__color"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col__3">
                        <div className="skills__box pointer">
                            ...
                            <div className="skills__meta">
                                <h1 className="skills__text">Client side</h1>
                                <p className="p skills__text p__color">JavaScript  + ES6 </p>
                                <p className="p skills__text p__color">React</p>
                                <p className="p skills__text p__color">Vue.js</p>
                                <p id="fake" className="p skills__text p__color"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col__3">
                        <div className="skills__box pointer">
                            ...
                            <div className="skills__meta">
                                <h1 className="skills__text">Web Design</h1>
                                <p className="p skills__text p__color">HTML5 </p>
                                <p className="p skills__text p__color">CSS3 </p>
                                <p className="p skills__text p__color">Bootstrap , Material-UI</p>
                                <p id="fake" className="p skills__text p__color"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col__3">
                        <div className="skills__box pointer">
                            ...
                            <div className="skills__meta">
                                <h1 className="skills__text">Databases</h1>
                                <p className="p skills__text p__color">Mongo DB</p>
                                <p className="p skills__text p__color">SQL Server </p>
                                <p className="p skills__text p__color">MySQL</p>
                                <p className="p skills__text p__color">Firebase </p>
                                <p id="fake"  className="p skills__text p__color"></p>
                            </div>
                        </div>
                    </div>
